...
namespace du.di {
	...
	public class TouchMgrImpl4Editor : TouchMgrImpl {
        public override int Count {
			get { return Step(0).IsTouching() ? 1 : 0; }
		}
		public override int FingerId(int index) {
			return Count;
		}
	...
	public class TouchMgrImpl4ActualMachine : TouchMgrImpl {
        public override int Count { get { return Input.touchCount; } }
		public override int FingerId(int index) {
	...
	public class TouchMgr : du.App.SingletonMonoBehaviour<TouchMgr> {
		...
		#region property
		public int       TouchCount  { get { return m_impl.Count; } }
		public TouchStep Step0       { get { return Step           (0); }}
		public bool      IsTouch     { get { return Step(0).IsTouching(); }}
		public Vector2?  Pos0        { get { return Position       (0); }}
		public Vector3?  Pos3D0      { get { return Position3D     (0); }}
		public Vector2?  WorldPos0   { get { return WorldPosition  (0); }}
		public Vector3?  WorldPos3D0 { get { return WorldPosition3D(0); }}
		#endregion
		...
		/// 一方、FingerIdは維持される
		/// </summary>
		public int FingerId(int index) {
			return m_impl.FingerId(index);
		}
		...
		public TouchStep Step(int index) {
			return m_impl.Step(index);
		}
		...
		public Vector2? Position(int index) {
			return m_impl.Position(index);
		}
		public Vector3? Position3D(int index) {
			return m_impl.Position(index);
		}
